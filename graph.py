...
# greedyalgo(cityhouses,W) # comment it out to see output of greedy algorithm
# knapsackhouse(cityhouses, W) # comment it out to see output of knapsack for houses
# knapsackcluster(cityhouses, pred1, W, no_of_transformers) # comment it out to see output of knapsack for clustering
# print(graph1)
dynamicpricing() # comment it out to see output of dynamic pricing

simulation(cityhouses, W, pred1, no_of_transformers)
for i in range(no_of_houses):
	cityhouses[i][2]=weightsconsumption[i]
# dynamicvsstatic() # comment it out to see difference between dynamic and static pricing
# twowayapproach(cityhouses, W, pred1, no_of_transformers,citytransformers) # comment it out to see output of two way algorithm